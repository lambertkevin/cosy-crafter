...
import TokenBlacklistSchema, { hiddenProperties } from '../schemas/TokenBlacklistSchema';
...
const schema = new mongoose.Schema(joigoose(mongoose).convert(TokenBlacklistSchema), {
  timestamps: true
});
